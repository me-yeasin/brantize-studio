                ...
                <div className="grid grid-cols-1 lg:grid-cols-2">
                  <div className="h-64 lg:h-auto relative overflow-hidden">
                    ...
                    {blogPosts.find(post => post.featured)?.coverImage && (
                      <Image 
                        src={blogPosts.find(post => post.featured)?.coverImage || ''} 
                        alt={blogPosts.find(post => post.featured)?.title || 'Featured post'} 
                  ...
                  <div className="p-8 flex flex-col justify-center">
                    <div className="flex items-center text-gray-400 text-sm mb-4">
                      <span className="flex items-center mr-4">
                        ...
                        {new Date(blogPosts.find(post => post.featured)?.publishedAt || '').toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}
                      </span>
                    ...
                    <p className="text-gray-400 mb-6">{blogPosts.find(post => post.featured)?.excerpt}</p>
                    <a 
                      href={`/blog/${blogPosts.find(post => post.featured)?.slug}`} 
