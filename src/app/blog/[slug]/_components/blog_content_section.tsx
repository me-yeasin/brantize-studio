        ...
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
          <div className="bg-gray-800 rounded-xl p-6 max-w-md w-full border border-gray-700 shadow-xl">
            <div className="text-center mb-6">
              <div className="mx-auto w-16 h-16 bg-gradient-to-r from-purple-600 to-lime-400 rounded-full flex items-center justify-center mb-4">
                <svg
              ...
              <p className="text-gray-400">
                ...
                you updated with the latest AI insights and news.
              </p>
            </div>
            <button
